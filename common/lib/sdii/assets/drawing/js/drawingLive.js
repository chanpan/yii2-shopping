...
function drawCanvas(width, height, outlineName, outlinePath, outlineBg)
{
    var context;
	...
	$(canvas).mousedown(function(e){
		...
		if ($(canvasDiv).children('.textAreaPopUp').length == 0) {
			...
			setTimeout(function(){ $(canvasDiv).children('.textAreaPopUp').children().children().children('.textareaInput').focus(); }, 200);
