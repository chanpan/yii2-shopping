    ...
    <div class="row cat-row category-page"><div class=""><aside id="column-left" class="col-sm-3 hidden-xs">
                ...
                <div class="panel panel-default refine-filter-box">
                    <div class="list-group">
                        <a class="list-group-item filter-heading" data-toggle="collapse" data-target="#filter-group1" aria-expanded="true">Color</a>
                        <div id="filter-group1" class="filter-group collapse in" aria-expanded="true" role="banner">
                            <div class="list-group-item one-blok">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="filter[]" value="1" />
                                        <span class="filter-name">Red (3)</span>
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="filter[]" value="2" />
                                        <span class="filter-name">Green (3)</span>
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="filter[]" value="3" />
                                        <span class="filter-name">Blue (0)</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <a class="list-group-item filter-heading" data-toggle="collapse" data-target="#filter-group2" aria-expanded="true">Size</a>
                        <div id="filter-group2" class="filter-group collapse in" aria-expanded="true" role="banner">
                            <div class="list-group-item one-blok">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="filter[]" value="4" />
                                        <span class="filter-name">Small (3)</span>
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="filter[]" value="5" />
                                        <span class="filter-name">Medium (3)</span>
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="filter[]" value="6" />
                                        <span class="filter-name">Large (3)</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <script type="te                xt/javascript"><!--
                    ...
                    location = 'http://opencart.webiarch.com/OCSK06/OCSK04/index.php?route=pr                oduct/category&path=20&filter=' + filter.join(',');
                    });
                    //--></script>
            </aside>
                ...
                <div id="cat-frist-row" class="row">
                    ...
                    <!-- <div class="col-md-3 col-sm-6">
                        <div class="form-group">
                         <a href="http://opencart.webiarch.com/OCSK06/OCSK04/index.php?route=product/compare" id="compare-total" class="btn btn-link">Product Compare (0)</a>
                       </div>
                     </div> -->
                    ...
                    <div class="col-md-3 col-lg-4 col-sm-4 col-xs-6                    catesort">
                        <div class="form-group input-group input                        -group-sm">
                            <label class="input-group-addon" for="input-limit">Sh                        ow:</label>
                            <select id="input-limit" class="form-control" onchang                                    e="location = this.value;">
                                <option value="http://opencart.webiarch.com/OCSK06/OCSK04/index.php?route=product/category&amp;path=20&amp;limit=9" sel                                    ected="selected">9</option>
                                <option value="http://opencart.webiarch.com/OCSK06/OCSK04/index.php?route=product/category&amp;path=2                                    0&amp;limit=25">25</option>
                                <option value="http://opencart.webiarch.com/OCSK06/OCSK04/index.php?route=product/category&amp;path=2                                    0&amp;limit=50">50</option>
                                <option value="http://opencart.webiarch.com/OCSK06/OCSK04/index.php?route=product/category&amp;path=2                                    0&amp;limit=75">75</option>
                                <option value="http://opencart.webiarch.com/OCSK06/OCSK04/index.php?route=product/category&amp;path=20&                                amp;limit=100">100</option>
                            </select>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="item">
                                <div class="product-thumb transition">
                                    <div class="image">
                                        ...
                                        <a href="http://opencart.webiarch.com/OCSK06/OCSK04/index.php?route=product/product&amp;path=20&amp;product_id=42">
                                             
                                            <img src="<?= $image.$p->product_image;?>" alt="Apple Cinema 30&quot;" title="Apple Cinema 30&quot;" class="img-responsive" />
                                            <!-- Webiarch Images Start -->
                                            <img src="<?= $image.$p->product_image;?>" class="img-responsive additional-home3" alt="Apple Cinema 30&quot;"/>
                                    ...
                                    <div class="caption">
                                        <p class="desc">
                                            ...
                                            30-inch (viewable) active-matrix liquid cryst..</p>
                                        <div class="rating">
                                        ...
                                        <h4 class="product-name"><a href="http://opencart.webiarch.com/OCSK06/OCSK04/index.php?route=product/product&amp;path=20&amp;product_id=42">Apple Cinema 30&quot;</a></h4>
                                        <p class="price">
                            ...
                            <ul class="pagination">
                                <li class="active">
                                    <span>1</span>
                                        ...
                                        <a href="">Next &gt;</a></li><li>
                                        <a href=""> End &gt;></a></li></ul><hr class="pagination-bottom"></div>
