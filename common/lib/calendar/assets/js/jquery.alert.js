(function(a) {
    a.alerts = {
        ...
        _show: function(j, b, k, g, m, l, c, f, n) {
            ...
            a("body").append('<div id="popup_container" style="display:none"><h3 id="popup_title"></h3><button id="popup_close">x</button><div id="popup_content"><div id="popup_message"></div></div></div>');
            if (a.alerts.dialogClass) {
            ...
            switch (g) {
                case "alert":
                    a("#popup_message").after('<div id="popup_panel"><input type="button" class="btn" value="' + a.alerts.okButton + '" id="popup_ok" /></div>');
                    ...
                    break;
                case "confirm":
                    a("#popup_message").after('<div id="popup_panel"><input type="button" class="btn btn-primary" value="' + a.alerts.okButton + '" id="popup_ok" /> <input type="button" class="btn" value="' + a.alerts.cancelButton + '" id="popup_cancel" /></div>');
                    a("#popup_ok").click(function() {
                        a.alerts._hide();
                        if (m) {
                            m(true)
                    ...
                    break;
                case "prompt":
                    a("#popup_message").append('<br /><input type="text" size="30" id="popup_prompt" />').after('<div id="popup_panel"><input type="button" class="btn btn-primary" value="' + a.alerts.okButton + '" id="popup_ok" /> <input type="button" class="btn" value="' + a.alerts.cancelButton + '" id="popup_cancel" /></div>');
