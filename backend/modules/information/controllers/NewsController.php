...
use backend\modules\information\models\News as NewsSearch;
...
public function actions()
{
    ...
    return [
        'browse-images' => [
            ...
            'maxHeight' => 800,
            'useHash' => true,
            'url' => '@storageUrl/web/image/',
            'path' => '@storageUrl/web/image/',
        ],
        'upload-images' => [
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "เพิ่มข่าวสาร",
                    'content'=>'<span class="text-success">เพิ่มข่าวสารสำเร็จ</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
