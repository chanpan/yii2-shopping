...
class DualListBox extends InputWidget {
    ...
    public function run()
    {
        ...
        $selected = (isset($this->model->$inputId) && $this->model->$inputId!='')?\yii\helpers\Json::decode($this->model->$inputId, JSON_UNESCAPED_UNICODE):null;
...
SCRIPT;
    ...
    {
        $view = $this->getView();
        \maksyutin\duallistbox\Asset::register($view);
//
//        $attr = $this->attribute;
//        $js = <<<SCRIPT
//
