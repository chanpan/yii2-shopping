        ...
        <div class="col-md-3">
            ...
            $form->field($model, 'distric')->widget(DepDrop::className(), [
                ...
                'pluginOptions' => [
                    ...
                    'url' => Url::to(['/sign-in/get-distric'])
                ]
            ])
            ?>
        </div>
        <div class="col-md-3">
            ...
            $form->field($model, 'zipcode')->widget(DepDrop::className(), [
                ...
                'pluginOptions' => [
                    ...
                    'url' => Url::to(['/sign-in/get-zipcode'])
                ]
            ])
            ?>
        ...
        <?php
            $this->registerJs("
                $('#department').click(function(){
                    var urls = '" . Url::to(['/sign-in/create-department']) . "';
                    showModal(urls,'เพิ่มคณะ');      
                    return false;
                });
                $('#subject').click(function(){
                    var urls = '" . Url::to(['/sign-in/create-subject']) . "';
